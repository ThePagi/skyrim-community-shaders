...
#	endif  // LANDSCAPE
		...
		float4 rawColorSample = TexColorSampler.Sample(SampColorSampler, diffuseUv);
		float4 colorSample = rawColorSample;
...
#	if defined(WORLD_MAP)
	baseColor.xyz = GetWorldMapBaseColor(rawColorSample.xyz, baseColor.xyz, texProjTmp);
#	endif  // WORLD_MAP
